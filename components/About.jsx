...
const About = () => {
  return (
<section className="w-full h-fit px-[40px] py-10 relative bg-white md:grid md:grid-cols-2 md:items-center md:text-left" id="about">
...
<div>
    ...
    <div className="grid justify-center items-center">
      <div className="md:grid grid-cols-2 ">
        ...
        <Image src="/assets/home.jpg" width={300} height={300} alt="Gabriel Menezes" className="rounded-full" />
        <p className="text-center">Legenda 1</p>
        </div>
        <div className="md:ml-3">
        <Image src="/assets/home.jpg" width={300} height={300} alt="Gabriel Menezes" className="rounded-full" />
        <p className="text-center">Legenda 1.1</p>
        </div>
      </div>
